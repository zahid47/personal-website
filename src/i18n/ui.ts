...
export const ui = {
  en: {
    ...
    "journey.1": "2014",
    "journey.1-text": "I started tinkering with computers when I was at high school and my fascination with technology began. Started learning coding and design.",
    "journey.2-text": "Started working as a freelance UI/UX designer and contributed to multiple products that successfully launched in app stores.",
    "journey.3-text": "Pursued my bachelor's degree in Software Engineering.",
    "journey.4-text": "Got my first job as a software engineer. Helped launch a new startup by contributing to key features.",
    "journey.5": "2022 - Current",
    "journey.5-text": "Got admitted to the B-JET program where I'm learning Japanese language, culture and business manners.",
    "journey.6": "Beyond",
    "journey.6-text": "I want to work as a software engineer in Japan and contrubute to impactful projects that will make a difference in people's lives.",
  ...
  jp: {
    ...
    "journey.1": "2014年",
    "journey.1-text": "高校生のときにコンピューターをいじり始め、テクノロジーに魅了され始めました。コーディングとデザインを学び始めました。",
    "journey.2-text": "フリーランスのUI / UXデザイナーとして働き始め、アプリストアでの立ち上げに成功した複数の製品に貢献しました。",
    "journey.3-text": "ソフトウェア工学の学士号を取得しました。",
    "journey.4-text": "ソフトウェアエンジニアとしての最初の仕事を得ました。主要な機能に貢献することで、新しいスタートアップの立ち上げを支援しました。",
    "journey.5": "2022年 - 現在",
    "journey.5-text": "日本語、日本文化、ビジネスマナーを学ぶB-JETプログラムに入学しました。",
    "journey.6": "下",
    "journey.6-text": "私は日本でソフトウェア エンジニアとして働き、人々の生活に変化をもたらす影響力のあるプロジェクトに貢献したいと思っています。",
    ...
    "projects.4.description": "既存の Spotify プレイリストから派生した、リミックスされた曲のカスタマイズされたプレイリスト。このアプリにより、ユーザーはお気に入りの曲を新鮮でエキサイティングな方法で楽しむことができます。",
